...
4. Plots the model
   ...
   ![](images/outputs/output_111_1.png)
...
## Classification: predicting heart disease on the framingham data-set
...
> 
> ![](images/outputs/output_166_4.png)
> 
>     
> ![](images/outputs/output_166_5.png)
> 
{: .solution}
...
> ```
>
> ![](images/outputs/output_171_0.png) 
> 
> ```python
> import datetime
> feature_list = list(features.columns)
...
> ```
>
> ![](images/outputs/output_172_0.png)
> 
{: .hands_on}
...
> print(f"Grid best score (r2): {grid_tree_acc.best_score_}") # get the best score calculated from the train/validation
> #dataset
> 
...
> 
>     
> ![](images/outputs/output_174_2.png)
>     
>
{: .solution}
...
> 
> y_decision_fn_scores_acc=grid_tree_acc.score(X_test, y_test)
> print(f"Grid best parameter (max. r2) model on test: {y_decision_fn_scores_acc}")# get the equivalent score on the test
...
>                   friend	0.000
>
> ![](images/outputs/output_177_2.png)
> 
> ![](images/outputs/output_177_5.png)
> 
{: .solution}
...
> 
>
> ![](images/outputs/output_180_2.png)
> 
>
> ![](images/outputs/output_180_5.png)
>
{: .solution}
